        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompetitorNumber = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RunningTime = table.Column<double>(type: "REAL", nullable: true),
                    SwimmingTime = table.Column<double>(type: "REAL", nullable: true),
                    ShootingScore = table.Column<int>(type: "INTEGER", nullable: true),
                    StrengthScore = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompetitionResults_Competitors_CompetitorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetitionResults_CompetitorId",
                table: "CompetitionResults",
                column: "CompetitorId");
        }
